...
import 'package:filmes/model/detalhe_filme_model.dart';
import 'package:filmes/model/filme_response_model.dart';
import 'package:http/http.dart' as http;

class FilmesApi {
  var client = http.Client();

  Future<FilmeResponseModel> getFilmes() async {
    try {
  ...
  Future<DetalheFilmeModel> filmeDetails(int moveId) async {
    try {
      var response = await client.get(Uri.parse(
